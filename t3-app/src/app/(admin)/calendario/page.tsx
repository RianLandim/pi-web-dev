...
export default function CalendarPage() {
  ...
  return (
    <main className="h-dvh w-full bg-main text-whiteApp">
      <CalendarEventCard />
      <article className="flex h-[92%] w-full flex-col space-y-5 px-6 pt-16 pb-6">
              ...
              <div className="flex w-full items-center justify-around">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <p>Prioridade alta</p>
                    <div className="h-3 w-3 rounded-full bg-[#FF1944]"></div>
                  </div>
                  <div className="flex items-center justify-between space-x-3">
                    <p>Prioridade média</p>
                    <div className="h-3 w-3 rounded-full bg-[#FFC800]"></div>
                  </div>
                  <div className="flex items-center justify-between space-x-3">
                    <p>Prioridade baixa</p>
                    <div className="h-3 w-3 rounded-full bg-[#208644]"></div>
                  </div>
                </div>
              </div>
            </motion.section>
